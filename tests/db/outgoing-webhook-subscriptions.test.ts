...
describe('outgoing_webhook_subscriptions — schema correctness (Phase 9 Unit 56)', () => {
  ...
  it('inserts a valid subscription', async () => {
    ...
    await db.query(
      `INSERT INTO outgoing_webhook_subscriptions (tenant_id, name, url, events, signing_secret_encrypted, signing_secret_kms_key_id)
       VALUES ($1,'Slack notifier','https://hooks.example/x', ARRAY['guest.created','payment.received'], decode('00112233445566778899aabbccddeeff00112233445566778899aabbccddeeff','hex'), 'arn:kms:key/abc')`,
      [t],
    );
    expect(
      (
        await db.query<{ c: number }>(
          `SELECT count(*)::int AS c FROM outgoing_webhook_subscriptions`,
        )
      ).rows[0]!.c,
    ).toBe(1);
  });
  ...
  it('rejects http:// URL', async () => {
    ...
    const err = await tryExec(
      ...
      `INSERT INTO outgoing_webhook_subscriptions (tenant_id, url, events, signing_secret_encrypted, signing_secret_kms_key_id)
       VALUES ($1,'http://insecure/x', ARRAY['guest.created'], decode('00112233445566778899aabbccddeeff00112233445566778899aabbccddeeff','hex'), 'arn:kms')`,
      [t],
    );
  ...
  it('rejects empty events array', async () => {
    ...
    const err = await tryExec(
      db,
      `INSERT INTO outgoing_webhook_subscriptions (tenant_id, url, events, signing_secret_encrypted, signing_secret_kms_key_id)
       VALUES ($1,'https://x/y', ARRAY[]::text[], decode('00112233445566778899aabbccddeeff00112233445566778899aabbccddeeff','hex'), 'arn:kms')`,
      [t],
    );
  ...
  it('rejects short signing secret (< 32 bytes)', async () => {
    ...
    const err = await tryExec(
      db,
      `INSERT INTO outgoing_webhook_subscriptions (tenant_id, url, events, signing_secret_encrypted, signing_secret_kms_key_id)
       VALUES ($1,'https://x/y', ARRAY['guest.created'], decode('abcd','hex'), 'arn:kms')`,
      [t],
    );
  ...
  it('rejects bad signing_algorithm', async () => {
    ...
    const err = await tryExec(
      ...
      `INSERT INTO outgoing_webhook_subscriptions (tenant_id, url, events, signing_secret_encrypted, signing_secret_kms_key_id, signing_algorithm)
       VALUES ($1,'https://x/y', ARRAY['e'], decode('00112233445566778899aabbccddeeff00112233445566778899aabbccddeeff','hex'), 'arn:kms','md5')`,
      [t],
    );
  ...
  it('total_failures > total_deliveries rejected', async () => {
    ...
    const err = await tryExec(
      ...
      `INSERT INTO outgoing_webhook_subscriptions (tenant_id, url, events, signing_secret_encrypted, signing_secret_kms_key_id, total_deliveries, total_failures)
       VALUES ($1,'https://x/y', ARRAY['e'], decode('00112233445566778899aabbccddeeff00112233445566778899aabbccddeeff','hex'), 'arn:kms', 5, 10)`,
      [t],
    );
  ...
  it('is_paused without reason rejected', async () => {
    ...
    const err = await tryExec(
      ...
      `INSERT INTO outgoing_webhook_subscriptions (tenant_id, url, events, signing_secret_encrypted, signing_secret_kms_key_id, is_paused, paused_at)
       VALUES ($1,'https://x/y', ARRAY['e'], decode('00112233445566778899aabbccddeeff00112233445566778899aabbccddeeff','hex'), 'arn:kms', TRUE, now())`,
      [t],
    );
  ...
  it('auto_disabled requires is_active=FALSE', async () => {
    ...
    const err = await tryExec(
      ...
      `INSERT INTO outgoing_webhook_subscriptions (tenant_id, url, events, signing_secret_encrypted, signing_secret_kms_key_id, auto_disabled_at, auto_disabled_reason)
       VALUES ($1,'https://x/y', ARRAY['e'], decode('00112233445566778899aabbccddeeff00112233445566778899aabbccddeeff','hex'), 'arn:kms', now(),'10 consecutive failures')`,
      [t],
    );
  ...
  it('timeout_seconds > 60 rejected', async () => {
    ...
    const err = await tryExec(
      ...
      `INSERT INTO outgoing_webhook_subscriptions (tenant_id, url, events, signing_secret_encrypted, signing_secret_kms_key_id, timeout_seconds)
       VALUES ($1,'https://x/y', ARRAY['e'], decode('00112233445566778899aabbccddeeff00112233445566778899aabbccddeeff','hex'), 'arn:kms', 120)`,
      [t],
    );
  ...
  it('last_status_code out of range rejected', async () => {
    ...
    const err = await tryExec(
      ...
      `INSERT INTO outgoing_webhook_subscriptions (tenant_id, url, events, signing_secret_encrypted, signing_secret_kms_key_id, last_status_code)
       VALUES ($1,'https://x/y', ARRAY['e'], decode('00112233445566778899aabbccddeeff00112233445566778899aabbccddeeff','hex'), 'arn:kms', 999)`,
      [t],
    );
  ...
  it('cross-tenant creator rejected', async () => {
    ...
    const err = await tryExec(
      ...
      `INSERT INTO outgoing_webhook_subscriptions (tenant_id, url, events, signing_secret_encrypted, signing_secret_kms_key_id, created_by)
       VALUES ($1,'https://x/y', ARRAY['e'], decode('00112233445566778899aabbccddeeff00112233445566778899aabbccddeeff','hex'), 'arn:kms', $2)`,
      [t1, mOther],
    );
  ...
  it('RLS pair', async () => {
    ...
    await db.query(
      `INSERT INTO outgoing_webhook_subscriptions (tenant_id, url, events, signing_secret_encrypted, signing_secret_kms_key_id)
       VALUES ($1,'https://x/y', ARRAY['e'], decode('00112233445566778899aabbccddeeff00112233445566778899aabbccddeeff','hex'), 'arn:kms')`,
      [t],
    );
    const anon = await withRole(
      ...
      'anon',
      async () =>
        (await db.query<{ id: string }>(`SELECT id FROM outgoing_webhook_subscriptions`)).rows
          .length,
    );
    expect(anon).toBe(0);
